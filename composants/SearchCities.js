...
export default function SearchCities({ setCity, department }) {
  ...
  const getSuggestions = useCallback(async (q) => {
    try {
      ...
      const response = await axios.get(
        `http://smartbins-back.herokuapp.com/api/utils/searchMunicipality/${department}/${q}`
      );
      ...
      <AutocompleteDropdown
        ...
        renderItem={(item, text) => (
          <Text
            onPress={() => {
              setCity(item.code);
              console.log("city_postal:", item.code);
